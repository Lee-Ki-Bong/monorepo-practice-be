...
@Entity("combine_board", { schema: "makeshop" })
export class CombineBoard {
  ...
  @Column("varchar", { name: "passwd", length: 128 })
  passwd: string;
  ...
  @Column("varchar", { name: "attach1", nullable: true, length: 255 })
  attach1: string | null;
  ...
  writePath: "" | "WEB" | "MOBILE" | "NAVER_PAY";
  ...
  useReplyComment: "" | "NONE" | "ONLY_REPLY" | "ONLY_COMMENT" | "BOTH";
