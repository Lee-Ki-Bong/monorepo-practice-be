...
@Index("index_ord_date", ["adminuser", "ordDate"], {})
@Index("index_ord_id_type", ["adminuser", "channelOrdId", "ordType"], {})
@Index("index_ord_num", ["adminuser", "channelOrdId", "num"], {})
@Index("index_ord_type", ["adminuser", "ordType"], {})
@Index("index_reg_date", ["adminuser", "regDate"], {})
@Index("index_search_date", ["adminuser", "searchDate"], {})
@Entity("custom_momq_order_detail_summary", { schema: "makeshop" })
export class CustomMomqOrderDetailSummary {
