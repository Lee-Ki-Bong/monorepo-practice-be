...
@Index(
  "delicompletedate_key",
  ["adminuser", "deliveryNum", "delicompleteDate"],
  {}
)
@Index("delidate_key", ["adminuser", "deliveryNum", "deliDate"], {})
@Index("delienddate_key", ["adminuser", "deliveryNum", "deliendDate"], {})
@Index("delinumdate_key", ["adminuser", "deliveryNum", "delinumDate"], {})
...
@Index("user_id_key", ["adminuser", "userId"], {})
@Entity("combine_oo_delivery", { schema: "makeshop" })
export class CombineOoDelivery {
  ...
  @Column("varchar", { name: "delinum", length: 150 })
  delinum: string;
