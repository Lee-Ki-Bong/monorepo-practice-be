...
@Index("c_ask_date", ["adminuser", "cancelaskDate"], {})
@Index("c_end_date", ["adminuser", "cancelendDate"], {})
...
@Index("mdate", ["adminuser", "addDate"], {})
@Index("oo_delivery_fk", ["adminuser", "deliveryNum"], {})
@Index("oo_only_status", ["adminuser", "basketStatus"], {})
@Index("oo_product", ["adminuser", "productUid", "prdOptionUid"], {})
@Index("oo_provider", ["adminuser", "provider", "ordernum"], {})
...
@Entity("oo_basket", { schema: "makeshop" })
export class OoBasket {
