...
@Entity("seil_settlement_schedule_order", { schema: "makeshop" })
export class SeilSettlementScheduleOrder {
  ...
  @Column("int", { name: "limit_avg_price", default: () => "'0'" })
  limitAvgPrice: number;
  ...
  @Column("int", { name: "ex_state_price", default: () => "'0'" })
  exStatePrice: number;

  @Column("int", { name: "ex_fee_sales_price", default: () => "'0'" })
  exFeeSalesPrice: number;

  @Column("int", { name: "ex_order_cnt", default: () => "'0'" })
  exOrderCnt: number;

  @Column("int", { name: "ex_fee_price", default: () => "'0'" })
  exFeePrice: number;

  @Column("int", { name: "ex_ext_price", default: () => "'0'" })
  exExtPrice: number;
