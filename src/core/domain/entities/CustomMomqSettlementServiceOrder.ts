...
@Index(
  "providerissue",
  ["adminuser", "type", "orderType", "provider", "issuedate"],
  {}
)
@Index(
  "sapcodeissue",
  ["adminuser", "type", "orderType", "sapSaleCode", "issuedate"],
  {}
)
@Index("type2", ["adminuser", "type", "orderType"], {})
@Entity("custom_momq_settlement_service_order", { schema: "makeshop" })
export class CustomMomqSettlementServiceOrder {
