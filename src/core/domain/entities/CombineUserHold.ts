...
@Index("custom_id", ["adminuser", "customId"], {})
@Index("date", ["date"], {})
@Index("email", ["adminuser", "email"], {})
@Index("group_id", ["adminuser", "groupId"], {})
@Index("hname", ["adminuser", "hname"], {})
@Index("lifetime", ["adminuser", "dateLifetime"], {})
@Index("login_date", ["adminuser", "lastLoginDate"], {})
@Index("mod_date", ["adminuser", "modDate"], {})
@Index("nickname", ["adminuser", "userNickname"], {})
@Index("recommand_id", ["adminuser", "recommandId"], {})
@Index("resno", ["adminuser", "resno"], {})
@Index("usergrade", ["adminuser", "grade"], {})
@Entity("combine_user_hold", { schema: "makeshop" })
export class CombineUserHold {
  ...
  @Column("varchar", { name: "recommand_id", nullable: true, length: 12 })
  ...
  @Column("varchar", { name: "membership_card", length: 16 })
  ...
  adultAuthType: "" | "NONE" | "IPIN" | "MOBILE";
