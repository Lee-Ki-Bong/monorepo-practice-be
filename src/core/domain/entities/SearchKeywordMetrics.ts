...
@Entity('searchkeyword', { schema: 'makeshop' })
export class SearchKeywordMetrics {
  ...
  @Column('varchar', { primary: true, name: 'keyword', length: 250 })
  keyword: string;
  ...
  devicePath: '' | 'WEB' | 'MOBILE' | 'POWERAPP';
  ...
  @Column('varchar', { name: 'randing', length: 255 })
  randing: string;
}
